...
- [Claude Code statusline with usage limits - GitHub Gist](https://gist.github.com/lexfrei/b70aaee919bdd7164f2e3027dc8c98de)
- [How to Show Claude Code Usage Limits in Your Statusline](https://codelynx.dev/posts/claude-code-usage-limits-statusline)
- [Claude Code ステータスバーにレートリミット情報を表示する](https://zenn.dev/suthio/articles/f832922e18f994)
